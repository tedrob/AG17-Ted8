...
export class SimpleinterestComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    this.context = (<HTMLCanvasElement>this.myCanvas.nativeElement).getContext(
      '2d'
    );
  }

  calculate() {
    console.log('in calculate ' + this.interestForm.controls['amount'].value);
  ...
  chart(principal, interest, monthly, payments) {
    ...
    g.globalAlpha = 0.95;
    g.fillStyle = 'green';//'green'; // Now use green paint
